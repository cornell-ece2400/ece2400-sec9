#=========================================================================
# slist-dpoly-reverse-v1-ploy.py
#=========================================================================
...
if not os.path.exists("slist-dpoly-reverse-v1-eval.txt"):
  print "slist-dpoly-reverse-v1-eval.txt does not exist!"
  exit(1)
...
with open("slist-dpoly-reverse-v1-eval.txt") as f:
  for line in f:
...
ax.grid()
fig.savefig( "slist-dpoly-reverse-v1-plot.pdf", bbox_inches='tight' )
